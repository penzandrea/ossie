...
@Component({
    selector: 'app-project-detail-filter-issues-1',
    templateUrl: './project-detail-filter-issues-1.component.html',
    styleUrls: ['./project-detail-filter-issues-1.component.css']
})
export class ProjectDetailFilterIssuesComponent1 implements OnInit {

    filter: Issue = new Issue();
    filterOne: Issue = new Issue();
    ...
    filterSeverity(id: string): void {
        ...
        console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!:     " + typeof this.filter.severity);
    ...
    filterOneSeverity(id: string): void {
        this.filterOne.severity = ""+id;
        console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!:     " + typeof this.filterOne.severity);

        console.log(id);
    }
    filterOneComponent(id: string): void {
        this.filterOne.component = ""+id;

        console.log(id);
    }
    filterOneRule(id: string): void {
        this.filterOne.rule = ""+id;
